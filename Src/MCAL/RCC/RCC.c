...
volatile uint32 rcc_G_bss_1;
volatile uint32 rcc_G_bss_2;
volatile uint32 rcc_G_bss_3;

volatile uint32 rcc_G_data_1 = 1000;
volatile uint32 rcc_G_data_2 = 2000;
volatile uint32 rcc_G_data_3 = 3000;

volatile const uint32 rcc_G_rodata_1 = 1111;
volatile const uint32 rcc_G_rodata_2 = 2222;
volatile const uint32 rcc_G_rodata_3 = 3333;
